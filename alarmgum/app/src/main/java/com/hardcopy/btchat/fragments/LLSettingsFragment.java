...
import com.hardcopy.btchat.IntroActivity;
import com.hardcopy.btchat.alarm;
...
public class LLSettingsFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		mGotoAlarm = (Button) rootView.findViewById(id.alram);
		mGotoAlarm.setOnClickListener(new View.OnClickListener() {
			@Override
